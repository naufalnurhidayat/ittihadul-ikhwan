<!DOCTYPE html>
  <html>
    ...
    <body>
            ...
            <nav class="orange darken-4">
                <div class="container">
                    <div class="nav-wrapper">
                        <a href="<?php echo e(url('/')); ?>" class="brand-logo"><img src="<?php echo e(asset('img/utilities/logo.png')); ?>" alt="Masjid Ittihadul Ikhwan" width="50" class="d-inline-block align-text-top"></a>
        ...
        <div class="slider">
            <ul class="slides">
                <li>
                    <img src="<?php echo e(asset('img/slider/slider1.jpg')); ?>">
                ...
                <li>
                    <img src="<?php echo e(asset('img/slider/slider2.jpeg')); ?>">
                ...
                <li>
                    <img src="<?php echo e(asset('img/utilities/banner.jpeg')); ?>">
        ...
        <div id="kegiatan" class="parallax-container scrollspy">
            <div class="parallax"><img src="<?php echo e(asset('img/utilities/banner.jpeg')); ?>"></div>
                        ...
                        <div class="col m4 s12">
                            <div class="card">
                                <div class="card-image">
                                    <img src="<?php echo e(asset('storage/'. $k->foto)); ?>">
                                </div>
                                <div class="card-content">
                                    <h6 class="card-title"><?php echo e($k->judul); ?></h6>
                                    <p><?php echo e($k->keterangan); ?></p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="lainnya scrollspy" id="lainnya">
            <div class="container">
                <div class="row">
                    ...
                    <?php $__currentLoopData = $lainnya; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col m4 s12">
                            <div class="card">
                                <div class="card-image">
                                    <img src="<?php echo e(asset('storage/'. $l->foto)); ?>">
                                </div>
                                <div class="card-content">
                                    <h6 class="card-title"><?php echo e($l->judul); ?></h6>
                                    <p><?php echo e($l->keterangan); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <footer class="white-text center orange darken-4">
            <p class="flow-text">Masjid Ittihadul Ikhwan. Copyright <?php echo e($tahun); ?></p>
        </footer>
  ...
  </html><?php /**PATH C:\xampp\htdocs\ittihadulIkhwan\resources\views/user/index.blade.php ENDPATH**/ ?>